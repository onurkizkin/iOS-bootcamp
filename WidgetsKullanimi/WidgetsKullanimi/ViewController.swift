...
class ViewController: UIViewController {
    ...
    @IBAction func buttonDzeko(_ sender: Any) {
        imageView.image = UIImage(named: "dzeko")
    }
    
    @IBAction func buttonSzymanski(_ sender: Any) {
        imageView.image = UIImage(named: "szymanski")
    }
